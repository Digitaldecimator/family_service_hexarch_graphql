...
// MockRepositoryFactory is a mock implementation of ports.RepositoryFactory
type MockRepositoryFactory struct {
	CloseFunc func(ctx context.Context) error
}

func (m *MockRepositoryFactory) NewParentRepository() interface{} {
	return nil
}

func (m *MockRepositoryFactory) NewChildRepository() interface{} {
	return nil
}

func (m *MockRepositoryFactory) GetTransactionManager() interface{} {
	return nil
}
...
func (m *MockRepositoryFactory) InitSchema(ctx context.Context) error {
	return nil
}
